...
const VehicleNotListed = () => {
    ...
    const goToMarketplace = () => {
        navigate("/marketplace", { state: { tab: "posting_soon" } });
    };
            ...
            <div className="py-5 px-4 md:px-6 md:mt-[56px] lg:px-8">
                ...
                <div className="mt-4 max-w-3xl md:flex">
                    ...
                    <div className="">
                        ...
                        <div className="flex">
                            <button type="button"
                                    onClick={openPostingSoonModal}
                                    className="bg-[#F5F9FF] text-[#1B74E4] border border-[#E1EEFF] flex items-center font-medium cursor-pointer py-1.5 px-3 rounded-lg mr-2 hover:bg-[#1B74E4] hover:text-white duration-300 ease-out">
                                <HiPlus size="20" className="mr-1"/> Post to Marketplace
                            </button>
                            <button type="button"
                            ...
                            <div className="fixed inset-0 flex items-center justify-center z-50">
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <Link to="/marketplace"
                                                    className="bg-[#F5F9FF] text-[#1B74E4] border border-[#E1EEFF] text-xs md:text-base flex items-center cursor-pointer py-1.5 px-3 rounded-lg hover:bg-[#1B74E4] hover:text-white duration-300 ease-out">
                                                <HiPlus size="20" className="mr-1"/> Add Another Vehicle
                                            </Link>
                                        </div>
                                        <div>
                                            <button type="button"
                                                    onClick={goToMarketplace}
                                                    className="bg-[#1B74E4] text-white border border-[#E1EEFF] text-xs md:text-base flex items-center cursor-pointer py-1.5 px-3 rounded-lg">
                                                <GoClock size="20" className="mr-1"/> View Posting Que
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
export default VehicleNotListed;