                ...
                <div className="mt-4 max-w-3xl md:flex">
                    ...
                    <div className="">
                        ...
                        <div className="flex items-center mb-3 md:mb-4">
                            <div className="text-[#1B74E4] text-xl md:text-2xl lg:text-[28px] mr-2 md:mr-3">
                                $17,995
                            </div>
                            <div
                                className="whitespace-nowrap text-[10px] md:text-xs font-medium text-white bg-[#FF0000] py-0.5 px-1.5 rounded-md">
                                Deleting
                            </div>
                        </div>
                        ...
                        <div className="flex">
                            <button type="button"
                                    ...
                                    className="bg-[#F5F9FF] text-[#1B74E4] border border-[#E1EEFF] flex items-center cursor-pointer py-1.5 px-3 rounded-lg hover:bg-[#1B74E4] hover:text-white duration-300 ease-out">
                                <FaRegTrashCan size="18" className="mr-1.5"/> Delete Listing
                            </button>
                        </div>
                        {showDeleteModal && (
...
export default VehicleDeleting;